...
The goal of the support vector machine technique is to identify a hyperplane in an "N" dimensional space (where N is the number of features) that categorizes the data points.
 ...
 There are two types of SVM "linear" and "non-linear", Linear SVM can be used when the data is perfectly linearly separable, and non-linear SVM used when the data is not linearly separable see Figure \ref{fig:linear}
